---
title: MARL / CTDE (多智能体强化学习)
description: 多智能体强化学习，采用集中训练、分散执行范式。
---
...
多智能体强化学习（Multi-Agent Reinforcement Learning）通过奖励机制训练多个 agent 在环境中协作或竞争。CTDE 即**集中训练**（Centralized Training）、**分散执行**（Decentralized Execution）。
